...
- [x] **ANOM-03**: When an anomaly is detected, Argus escalates to HITL gate with context banner showing rate, baseline, z-score, and last N tool calls
- [x] **ANOM-04**: Anomaly events are written to audit log and emitted as OTel spans (`GateType.ANOMALY`)
...
| ANOM-03 | Phase 10 | Complete |
| ANOM-04 | Phase 10 | Complete |
